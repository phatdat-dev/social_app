...
class Facebook_Card_Comment extends StatelessWidget {
  ...
  Facebook_Card_Comment({required this.comment_username, required this.comment_profile_pic, required this.comment_text});
          ...
          children: <Widget>[
            Padding(
              ...
              child: Container(
                height: 40,
                width: 40,
                decoration: BoxDecoration(shape: BoxShape.circle, image: DecorationImage(image: AssetImage(comment_profile_pic), fit: BoxFit.cover)),
              ),
            ),
            Padding(
