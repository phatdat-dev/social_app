  ...
  Widget build(BuildContext context) {
    return MultiProvider(
        providers: [
          ...
          ChangeNotifierProvider.value(value: controller.groupController.fetchPostGroupController),
        ],
        child: ListView(
          ...
          children: <Widget>[
            ...
            //
            Selector(
              selector: (_, GroupController controller) => controller.fetchPostGroupController.dataResponse,
